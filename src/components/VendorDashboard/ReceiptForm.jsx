...
const ReceiptForm = ({ businessName }) => {
  const [formData, setFormData] = useState(() => {
    ...
    return savedData
      ...
      : {
          ...
          advanceAmount: "",
          totalWithAdvance: "",
          isEditing: true, // This is the new state property
        };
  });
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        setToastMessage("Failed to fetch customer data.");
  ...
  const handleSave = () => {
    ...
    if (formData.id) {
      ...
      setToastMessage("Receipt updated successfully!");
    } else {
      // Add new receipt
              ...
              <tr>
                ...
                <td className="border p-2 text-right">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full text-right bg-transparent border-b border-gray-300 focus:outline-none"
                  />
                </td>
            ...
            <div className="w-1/2 ml-4 p-2 border border-gray-400 rounded-md">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="text-right bg-transparent border-b border-gray-300 focus:outline-none"
                />
              </div>
              ...
              {filteredReceipts.map((receipt) => (
                <tr key={receipt.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center space-x-2">
                    ...
                    <button
                      onClick={() => handleTablePrint(receipt.id)}
