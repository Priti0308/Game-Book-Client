...
// Empty state component for no data or errors
...
      try {
        const reportApiUrl = `${API_BASE_URI}/api/reports/${customer._id}`;

        const [dailyRes, monthlyRes] = await Promise.all([
          axios.get(reportApiUrl, {
...
                <p className="text-3xl font-bold text-green-900">₹{monthlyIncome.toLocaleString('en-IN')}</p>
            </div>
        </div>
      )}
    </div>
